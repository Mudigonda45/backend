...
public class Booking {
    ...
    public byte[] getPaymentScreenshot() { return paymentScreenshot; }
    public void setPaymentScreenshot(byte[] paymentScreenshot) { this.paymentScreenshot = paymentScreenshot; }
}